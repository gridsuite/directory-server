...
public class ElementAttributesTest {
    ...
    public void testElementEntityUpdate() {
        ...
        DirectoryElementEntity elementEntity = new DirectoryElementEntity(ELEMENT_UUID, ELEMENT_UUID, "name", ElementType.DIRECTORY.name(), true, "userId", "description", localCreationDate, localCreationDate, "userId", false, null);
        DirectoryElementEntity elementEntity2 = new DirectoryElementEntity(ELEMENT_UUID, ELEMENT_UUID, "name", ElementType.STUDY.name(), true, "userId", "description", localCreationDate, localCreationDate, "userId", false, null);
        ...
        assertFalse(elementEntity.isAttributesUpdatable(ElementAttributes.builder().type(ElementType.STUDY.name()).build(), "userId"));
        ...
        org.hamcrest.MatcherAssert.assertThat(toElementAttributes(ELEMENT_UUID, "newName", ElementType.DIRECTORY.name(), false, "userId", "description", ZonedDateTime.ofInstant(elementEntity.getCreationDate().toInstant(ZoneOffset.UTC), ZoneOffset.UTC), ZonedDateTime.ofInstant(elementEntity.getLastModificationDate().toInstant(ZoneOffset.UTC), ZoneOffset.UTC), "userId"), new MatcherJson<>(mapper, toElementAttributes(elementEntity)));
    }
    ...
    public void testElementAttributesCreation() {
        ...
        verifyElementAttributes(toElementAttributes(ELEMENT_UUID, "name", ElementType.DIRECTORY.name(), new AccessRightsAttributes(true), "userId", 1L, "description", zonedCreationDate, zonedCreationDate, "userId"));
        verifyElementAttributes(toElementAttributes(null, "name", ElementType.DIRECTORY.name(), new AccessRightsAttributes(true), "userId", 1L, "description", zonedCreationDate, zonedCreationDate, "userId"));
        verifyElementAttributes(toElementAttributes(ELEMENT_UUID, "name", ElementType.DIRECTORY.name(), new AccessRightsAttributes(true), "userId", 1L, null, zonedCreationDate, zonedCreationDate, "userId"));

        verifyElementAttributes(toElementAttributes(ELEMENT_UUID, "name", ElementType.DIRECTORY.name(), true, "userId", "description"));
        verifyElementAttributes(toElementAttributes(ELEMENT_UUID, "name", ElementType.DIRECTORY.name(), true, "userId"));

        verifyElementAttributes(toElementAttributes(new DirectoryElementEntity(ELEMENT_UUID, ELEMENT_UUID, "name", ElementType.DIRECTORY.name(), true, "userId", "description", localCreationDate, localCreationDate, "userId", false, null)));
        verifyElementAttributes(toElementAttributes(new DirectoryElementEntity(ELEMENT_UUID, ELEMENT_UUID, "name", ElementType.DIRECTORY.name(), true, "userId", "description", localCreationDate, localCreationDate, "userId", false, null), 1L));
        ...
        assertThrows(NullPointerException.class, () -> toElementAttributes(ELEMENT_UUID, "name", ElementType.DIRECTORY.name(), true, "userId", null));
        assertThrows(NullPointerException.class, () -> toElementAttributes(ELEMENT_UUID, null, ElementType.DIRECTORY.name(), accessRightsAttributes, "userId", 1L, "description", zonedCreationDate, zonedCreationDate, "userId"));
        ...
        assertThrows(NullPointerException.class, () -> toElementAttributes(ELEMENT_UUID, "name", ElementType.DIRECTORY.name(), null, "userId", 1L, "description", zonedCreationDate, zonedCreationDate, "userId"));
        assertThrows(NullPointerException.class, () -> toElementAttributes(ELEMENT_UUID, "name", ElementType.DIRECTORY.name(), accessRightsAttributes, null, 1L, "description", zonedCreationDate, zonedCreationDate, "userId"));
    }

    @Test
    public void testAllowedUser() {
        assertTrue(toElementAttributes(ELEMENT_UUID, "dir", ElementType.DIRECTORY.name(), false, "user").isAllowed("user"));
        assertTrue(toElementAttributes(ELEMENT_UUID, "dir", ElementType.DIRECTORY.name(), false, "user").isAllowed("user1"));
        assertTrue(toElementAttributes(ELEMENT_UUID, "dir", ElementType.DIRECTORY.name(), true, "user").isAllowed("user"));
        assertFalse(toElementAttributes(ELEMENT_UUID, "dir", ElementType.DIRECTORY.name(), true, "user").isAllowed("user1"));

        ElementAttributes notDirectory = toElementAttributes(ELEMENT_UUID, "study", ElementType.STUDY.name(), false, "userId");
    ...
    public void testJsonString() {
        ...
        assertEquals(
            ...
            toJsonString(toElementAttributes(UUID.fromString("21297976-7445-44f1-9ccf-910cbb2f84f8"), "name", ElementType.DIRECTORY.name(), new AccessRightsAttributes(true), "userId", 1L, "description", creationDate, creationDate, "userId"))
        );
    }
