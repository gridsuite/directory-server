...
public class ElementAttributesTest {
    ...
    public void testElementEntityUpdate() {
        ...
        DirectoryElementEntity elementEntity = new DirectoryElementEntity(ELEMENT_UUID, ELEMENT_UUID, "name", ElementType.DIRECTORY.name(), true, "userId", "description", localCreationDate, localCreationDate, "userId");
        DirectoryElementEntity elementEntity2 = new DirectoryElementEntity(ELEMENT_UUID, ELEMENT_UUID, "name", ElementType.STUDY.name(), true, "userId", "description", localCreationDate, localCreationDate, "userId");
    ...
    public void testElementAttributesCreation() {
        ...
        verifyElementAttributes(toElementAttributes(new DirectoryElementEntity(ELEMENT_UUID, ELEMENT_UUID, "name", ElementType.DIRECTORY.name(), true, "userId", "description", localCreationDate, localCreationDate, "userId")));
        verifyElementAttributes(toElementAttributes(new DirectoryElementEntity(ELEMENT_UUID, ELEMENT_UUID, "name", ElementType.DIRECTORY.name(), true, "userId", "description", localCreationDate, localCreationDate, "userId"), 1L));
