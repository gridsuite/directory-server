...
public class DirectoryTest {
    ...
    public void test() throws Exception {
        ...
        ElementAttributes subDirAttributes = toElementAttributes(null, "newSubDir", ElementType.DIRECTORY, true, "userId");
        ...
        checkRootDirectoriesList("userId", List.of(toElementAttributes(uuidNewDirectory, "newName", ElementType.DIRECTORY, false, "userId", null, creationDateNewDirectory, creationDateNewDirectory, "userId")));
        ...
        checkRootDirectoriesList("userId", List.of(toElementAttributes(uuidNewDirectory, "newName", ElementType.DIRECTORY, true, "userId", null, creationDateNewDirectory, creationDateNewDirectory, "userId")));

        // Add another sub-directory
        ElementAttributes newSubDirAttributes = toElementAttributes(null, "newSubDir", ElementType.DIRECTORY, true, "userId", "descr newSubDir");
        ...
        // Add another sub-directory
        ElementAttributes newSubSubDirAttributes = toElementAttributes(null, "newSubSubDir", ElementType.DIRECTORY, true, "userId");
        ...
        checkRootDirectoriesList("userId", List.of(toElementAttributes(uuidNewDirectory, "newName", ElementType.DIRECTORY, new AccessRightsAttributes(true), "userId", 1L, null, creationDateNewDirectory, creationDateNewDirectory, "userId")));
    ...
    public void testGetPathOfStudy() throws Exception {
     // Insert a public root directory
        ...
        ElementAttributes directory1Attributes = toElementAttributes(directory1UUID, "directory1", ElementType.DIRECTORY, null, "Doe");
        ...
        ElementAttributes directory2Attributes = toElementAttributes(directory2UUID, "directory2", ElementType.DIRECTORY, null, "Doe");
    ...
    public void testGetPathOfNotAllowed() throws Exception {
     // Insert a public root directory
        ...
        // Insert a subDirectory1 in the root directory
        UUID directory1UUID = UUID.randomUUID();
        ElementAttributes directory1Attributes = toElementAttributes(directory1UUID, "directory1", ElementType.DIRECTORY, false, "Doe");
        insertAndCheckSubElement(rootDirUuid, false, directory1Attributes);

        // Insert a private subDirectory2 in the subDirectory1 directory
        UUID directory2UUID = UUID.randomUUID();
        ElementAttributes directory2Attributes = toElementAttributes(directory2UUID, "directory2", ElementType.DIRECTORY, true, "Doe");
        insertAndCheckSubElement(directory1UUID, false, directory2Attributes);
    ...
    public void testMoveElement() throws Exception {
        ...
        ElementAttributes directory20Attributes = toElementAttributes(directory21UUID, "directory20", ElementType.DIRECTORY, false, "Doe");
        ...
        ElementAttributes filterAttributes = toElementAttributes(filterUuid, "filter", ElementType.FILTER, null, "Doe");
    ...
    public void testMoveElementFromDifferentAccessRightsFolder() throws Exception {
        ...
        ElementAttributes directory20Attributes = toElementAttributes(directory21PrivateUUID, "directory20", ElementType.DIRECTORY, true, "Doe");
        insertAndCheckSubElement(rootDir20Uuid, false, directory20Attributes);
    ...
    public void testMoveElementWithAlreadyExistingNameAndTypeInDestination() throws Exception {
        ...
        ElementAttributes filterwithSameNameAndTypeAttributes = toElementAttributes(filterwithSameNameAndTypeUuid, "filter", ElementType.FILTER, null, "Doe");
    ...
    public void testMoveElementToNotDirectory() throws Exception {
        ...
        ElementAttributes filter2Attributes = toElementAttributes(filter2Uuid, "filter2", ElementType.FILTER, null, "Doe");
    ...
    public void testMoveStudy() throws Exception {
        ...
        ElementAttributes study21Attributes = toElementAttributes(study21UUID, "Study21", ElementType.STUDY, null, "Doe");
    ...
    public void testTwoUsersTwoPrivateDirectories() throws Exception {
        ...
        checkRootDirectoriesList("user1", List.of(toElementAttributes(rootDir1Uuid, "rootDir1", ElementType.DIRECTORY, true, "user1", null, rootDir1CreationDate, rootDir1CreationDate, "user1")));

        checkRootDirectoriesList("user2", List.of(toElementAttributes(rootDir2Uuid, "rootDir2", ElementType.DIRECTORY, true, "user2", null, rootDir2CreationDate, rootDir2CreationDate, "user2")));
    ...
    public void testTwoUsersTwoStudiesInPublicDirectory() throws Exception {
        ...
        ElementAttributes study1Attributes = toElementAttributes(UUID.randomUUID(), "study1", ElementType.STUDY, null, "user1");
        insertAndCheckSubElement(rootDirUuid, false, study1Attributes);

        // Insert a study in the root directory by the user1
        ElementAttributes study2Attributes = toElementAttributes(UUID.randomUUID(), "study2", ElementType.STUDY, null, "user2", "descr study2");
    ...
    public void testTwoUsersElementsWithSameName() throws Exception {
        ...
        ElementAttributes study2Attributes = toElementAttributes(UUID.randomUUID(), "study1", ElementType.STUDY, null, "user1");
        insertExpectFail(rootDirUuid, study2Attributes);

        // Insert a study in the root directory by the user1
        ElementAttributes study3Attributes = toElementAttributes(UUID.randomUUID(), "study3", ElementType.STUDY, null, "user1");
        insertAndCheckSubElement(rootDirUuid, false, study3Attributes);

        // Insert a study with the same name in the root directory by the user1 and expect a 403
        ElementAttributes study4Attributes = toElementAttributes(UUID.randomUUID(), "study3", ElementType.STUDY, null, "user1");
        ...
        ElementAttributes filterAttributes = toElementAttributes(UUID.randomUUID(), "study3", ElementType.FILTER, null, "user1");
        ...
        ElementAttributes study5Attributes = toElementAttributes(UUID.randomUUID(), "study3", ElementType.STUDY, null, "user3");
    ...
    public void testTwoUsersTwoStudies() throws Exception {
        ...
        // Insert a public study in the root directory by the user1
        ElementAttributes study2Attributes = toElementAttributes(UUID.randomUUID(), "study2", ElementType.STUDY, null, "user2");
        insertAndCheckSubElement(rootDirUuid, false, study2Attributes);
    ...
    public void testRecursiveDelete() throws Exception {
        ...
        ElementAttributes study1Attributes = toElementAttributes(UUID.randomUUID(), "study1", ElementType.STUDY, null, "userId", "descr study1");
        insertAndCheckSubElement(rootDirUuid, true, study1Attributes);

        // Insert a public study in the root directory by the userId;
        ElementAttributes study2Attributes = toElementAttributes(UUID.randomUUID(), "study2", ElementType.STUDY, null, "userId");
        insertAndCheckSubElement(rootDirUuid, true, study2Attributes);

        // Insert a subDirectory
        ElementAttributes subDirAttributes = toElementAttributes(UUID.randomUUID(), "subDir", ElementType.DIRECTORY, true, "userId");
        insertAndCheckSubElement(rootDirUuid, true, subDirAttributes);

        // Insert a study in the root directory by the userId
        ElementAttributes subDirStudyAttributes = toElementAttributes(UUID.randomUUID(), "study3", ElementType.STUDY, null, "userId", "descr study3");
    ...
    public void testRenameStudy() throws Exception {
        ...
        // Insert a study in the root directory by the user1
        ElementAttributes study1Attributes = toElementAttributes(STUDY_RENAME_UUID, "study1", ElementType.STUDY, null, "user1");
        insertAndCheckSubElement(rootDirUuid, false, study1Attributes);

        assertNbElementsInRepositories(2);

        renameElement(study1Attributes.getElementUuid(), rootDirUuid, "user1", "newName1", false, false);
        checkDirectoryContent(rootDirUuid, "userId", List.of(toElementAttributes(study1Attributes.getElementUuid(), "newName1", ElementType.STUDY, null, "user1", null, study1Attributes.getCreationDate(), study1Attributes.getLastModificationDate(), "user1")));
    ...
    public void testRenameStudyToSameName() throws Exception {
        ...
        checkDirectoryContent(rootDirUuid, "userId", List.of(toElementAttributes(study1Attributes.getElementUuid(), "study1", ElementType.STUDY, null, "user1", null, study1Attributes.getCreationDate(), study1Attributes.getLastModificationDate(), "user1")));
    }
    ...
    public void testRenameStudyForbiddenFail() throws Exception {
        ...
        // Insert a study in the root directory by the user1
        ElementAttributes study1Attributes = toElementAttributes(STUDY_RENAME_FORBIDDEN_UUID, "study1", ElementType.STUDY, null, "user1");
        insertAndCheckSubElement(rootDirUuid, true, study1Attributes);
    ...
    public void testRenameElementWithSameNameAndTypeInSameDirectory() throws Exception {
        ...
        ElementAttributes study1Attributes = toElementAttributes(UUID.randomUUID(), "study1", ElementType.STUDY, null, "Doe");
        insertAndCheckSubElement(rootDirUuid, false, study1Attributes);

        // Insert a public study2 in the root directory by Doe;
        ElementAttributes study2Attributes = toElementAttributes(UUID.randomUUID(), "study2", ElementType.STUDY, null, "Doe");
        insertAndCheckSubElement(rootDirUuid, false, study2Attributes);
    ...
    public void testRenameDirectoryNotAllowed() throws Exception {
        ...
        checkRootDirectoriesList("Doe", List.of(toElementAttributes(rootDirUuid, "rootDir1", ElementType.DIRECTORY, true, "Doe", null, rootDirCreationDate, rootDirCreationDate, "Doe")));
    ...
    public void testUpdateStudyAccessRight() throws Exception {
        ...
        // Insert a study in the root directory by the user1
        ElementAttributes study1Attributes = toElementAttributes(STUDY_UPDATE_ACCESS_RIGHT_UUID, "study1", ElementType.STUDY, null, "user1");
        insertAndCheckSubElement(rootDirUuid, false, study1Attributes);

        //set study to private -> not updatable
        updateAccessRightFail(study1Attributes.getElementUuid(), "user1", true, 403);
        checkDirectoryContent(rootDirUuid, "user1", List.of(toElementAttributes(study1Attributes.getElementUuid(), "study1", ElementType.STUDY, null, "user1", null, study1Attributes.getCreationDate(), study1Attributes.getLastModificationDate(), "user1")));
    }
    ...
    public void testUpdateDirectoryAccessRight() throws Exception {
        ...
        checkRootDirectoriesList("Doe", List.of(toElementAttributes(rootDirUuid, "rootDir1", ElementType.DIRECTORY, false, "Doe", null, rootDirCreationDate, rootDirCreationDate, "Doe")));
    ...
    public void testEmitDirectoryChangedNotification() {
        ...
        ElementAttributes contingencyListAttributes = toElementAttributes(UUID.randomUUID(), "CL1", ElementType.CONTINGENCY_LIST, null, "Doe");
    ...
    public void testGetElement() {
        ...
        // Insert a contingency list in the root directory by the user1
        ElementAttributes contingencyAttributes = toElementAttributes(CONTINGENCY_LIST_UUID, "Contingency", ElementType.CONTINGENCY_LIST, null, "user1");
        insertAndCheckSubElement(rootDirUuid, false, contingencyAttributes);

        // Insert a filter in the root directory by the user1
        ElementAttributes filterAttributes = toElementAttributes(FILTER_UUID, "Filter", ElementType.FILTER, null, "user1");
        insertAndCheckSubElement(rootDirUuid, false, filterAttributes);

        // Insert a script in the root directory by the user1
        ElementAttributes scriptAttributes = toElementAttributes(UUID.randomUUID(), "Script", ElementType.FILTER, null, "user1");
        ...
        res.sort(Comparator.comparing(ElementAttributes::getElementName));
        ElementAttributes newContingency = toElementAttributes(contingencyAttributes.getElementUuid(), "newContingency", ElementType.CONTINGENCY_LIST, null, "user1", null, contingencyAttributes.getCreationDate(), contingencyAttributes.getLastModificationDate(), "user1");
        ElementAttributes newFilter = toElementAttributes(filterAttributes.getElementUuid(), "newFilter", ElementType.FILTER, null, "user1", null, filterAttributes.getCreationDate(), filterAttributes.getLastModificationDate(), "user1");
        ElementAttributes newScript = toElementAttributes(scriptAttributes.getElementUuid(), "newScript", ElementType.FILTER, null, "user1", null, scriptAttributes.getCreationDate(), scriptAttributes.getLastModificationDate(), "user1");
        ...
        org.hamcrest.MatcherAssert.assertThat(result, new MatcherJson<>(objectMapper, List.of(
                toElementAttributes(FILTER_UUID, "newFilter", ElementType.FILTER, new AccessRightsAttributes(null), "user1", 0, null, filterAttributes.getCreationDate(), filterAttributes.getLastModificationDate(), "user1"),
                directory
        )));

        ElementAttributes subDirAttributes = toElementAttributes(null, "newSubDir", ElementType.DIRECTORY, true, "user1");
        insertAndCheckSubElement(rootDirUuid, false, subDirAttributes);
        insertAndCheckSubElement(subDirAttributes.getElementUuid(), true, toElementAttributes(null, "subDirContingency", ElementType.CONTINGENCY_LIST, null, "user1"));
    ...
    public void testRootDirectoryExists() throws Exception {
        ...
        ElementAttributes directory20Attributes = toElementAttributes(directoryUUID, "directoryToFind", ElementType.DIRECTORY, false, "Doe");
    ...
    public void testCreateDirectoryWithEmptyName() throws Exception {
        ...
        ElementAttributes directoryWithoutNameAttributes = toElementAttributes(UUID.randomUUID(), "", ElementType.DIRECTORY, null, "user1");
    ...
    public void testStashAndRestoreElements() {
        ...
        ElementAttributes subDirAttributes1 = toElementAttributes(subDirUuid1, "newSubDir1", ElementType.DIRECTORY, true, "userId");

        UUID subDirUuid2 = UUID.randomUUID();
        ElementAttributes subDirAttributes2 = toElementAttributes(subDirUuid2, "newSubDir2", ElementType.DIRECTORY, false, "userId");

        UUID subDirUuid3 = UUID.randomUUID();
        ElementAttributes subDirAttributes3 = toElementAttributes(subDirUuid3, "newSubDir3", ElementType.DIRECTORY, true, "userId2");

        UUID subDirUuid4 = UUID.randomUUID();
        ElementAttributes subDirAttributes4 = toElementAttributes(subDirUuid4, "newSubDir4", ElementType.DIRECTORY, false, "userId2");
    ...
    private ElementAttributes retrieveInsertAndCheckRootDirectory(String rootDirectoryName, boolean isPrivate, String userId) throws Exception {
        ...
        ElementAttributes newDirectoryAttributes = toElementAttributes(uuidNewDirectory, rootDirectoryName, ElementType.DIRECTORY, isPrivate, userId, null, creationDateNewDirectory, creationDateNewDirectory, userId);
    ...
    private UUID insertAndCheckRootDirectory(String rootDirectoryName, boolean isPrivate, String userId) throws Exception {
        ...
        assertElementIsProperlyInserted(toElementAttributes(uuidNewDirectory, rootDirectoryName, ElementType.DIRECTORY, isPrivate, userId, null, creationDateNewDirectory, creationDateNewDirectory, userId));
    ...
    public void testCreateElementInDirectory() {
        ...
        ElementAttributes caseElement = ElementAttributes.toElementAttributes(UUID.randomUUID(), "caseName", ElementType.CASE,
        ...
        assertEquals(ElementType.DIRECTORY, dir1.getType());
        ...
        assertEquals(ElementType.DIRECTORY, dir2.getType());
    ...
    public void testCreateModificationElementWithAutomaticNewName() {
        ...
        ElementAttributes modifAttributes = toElementAttributes(UUID.randomUUID(), modifElementName, ElementType.MODIFICATION, null, userId);
        ...
        ElementAttributes anotherModifAttributes = toElementAttributes(UUID.randomUUID(), modifElementName, ElementType.MODIFICATION, null, userId);
    ...
    public void testReindexAll() {
        ...
        DirectoryElementEntity dirEntity = new DirectoryElementEntity(UUID.randomUUID(), UUID.randomUUID(), "name", ElementType.DIRECTORY, true, "userId", "description", now, now, "userId", false, null);
        DirectoryElementEntity studyEntity = new DirectoryElementEntity(UUID.randomUUID(), UUID.randomUUID(), "name", ElementType.STUDY, true, "userId", "description", now, now, "userId", false, null);
